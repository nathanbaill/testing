...
\titlegraphic{\includegraphics[width=2cm]{image/logo-papit.png}\bgibreak
...
def customer_without_table():
    ...
    \begin{frame}[fragile]
        ...
        \begin{columns}
            ...
            \column{0.1\textwidth}
            \centering
            \includegraphics[width=1cm]{image/logo-pycharm.jpeg}
        \end{columns}
    \end{frame}
    ...
    \begin{frame}[fragile]
        ...
        \begin{columns}
            ...
            La liste est trop longue, nous venons juste d'en découvrir les principales.
            \bigbreak
